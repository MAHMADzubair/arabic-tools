...
const COUNTRY_HUBS = {
  sa: {
    ...
    primaryTools: [
      ...
      {
        id: "article-77",
        nameAr: "حاسبة تعويض المادة 77 (الفصل التعسفي)",
        nameEn: "Article 77 Termination Calculator",
        icon: "⚖️",
        badge: "الفصل لسبب غير مشروع",
        badgeColor: "bg-rose-50 text-rose-800 border-rose-200 font-black",
        href: "/ar/sa/article-77-calculator",
        desc: "احسب تعويض إنهاء العقد لسبب غير مشروع بموجب المادة (77): 15 يوماً عن كل سنة، أو أجر المدة المتبقية مع تطبيق حد الشهرين الأدنى.",
        highlights: [
          "عقود محددة وغير محددة المدة",
          "تطبيق حد أجر الشهرين الإلزامي",
          "تحديد حق العامل أو المنشأة",
    ...
    upcomingTool: {
      ...
      title: "حاسبة الترقية واستحقاقات البدلات وفروقات سلم الرواتب",
      desc: "حساب الأثر المالي للترقيات الوظيفية وتعديل البدلات واحتساب فروقات الأثر الرجعي في عقود العمل ومنصة قوى.",
      status: "قريباً جداً في هذا المجمع",
      plannedFeatures: [
        "حساب الفروقات المالية بأثر رجعي",
        "تعديل بدلات السكن والنقل والبدلات المتغيرة",
        "تحديث أوعية التأمينات الاجتماعية GOSI",
        "إصدار إشعار تعديل المزايا التعاقدية",
      ],
    },
