...
export const metadata = {
  title: "حاسبة المخالصة النهائية في السعودية 2026 | مكافأة + إجازة + إشعار",
  description:
    "احسب مخالصتك النهائية بدقة وفق نظام العمل السعودي 2026: مكافأة نهاية الخدمة (م/84 و85)، بدل الإجازة السنوية (م/111)، مهلة الإشعار (م/75 و76)، وجميع الخصومات. أنشئ نموذج مخالصة نهائية جاهز للطباعة.",
  keywords: [
  ...
  openGraph: {
    title: "حاسبة المخالصة النهائية في السعودية 2026 | مكافأة + إجازة + إشعار",
    description:
      "احسب مخالصتك كاملة: مكافأة نهاية الخدمة + بدل إجازة + مهلة إشعار + خصومات. أنشئ نموذج مخالصة نهائية جاهز للطباعة والتوقيع.",
    type: "website",
    locale: "ar_SA",
  },
};
