...
export const metadata = {
  title: "حاسبة المخالصة النهائية في السعودية 2025 | مكافأة + إجازة + إشعار",
  description:
    "احسب مخالصتك النهائية بدقة وفق نظام العمل السعودي 2025: مكافأة نهاية الخدمة (م/84 و85)، بدل الإجازة السنوية (م/111)، مهلة الإشعار (م/75 و76)، وجميع الخصومات. أصدر وثيقة مخالصة جاهزة للطباعة.",
  keywords: [
  ...
  openGraph: {
    title: "حاسبة المخالصة النهائية في السعودية 2025",
    description:
      "احسب مخالصتك كاملة: مكافأة نهاية الخدمة + بدل إجازة + مهلة إشعار + خصومات. وثيقة مخالصة جاهزة للطباعة.",
    type: "website",
    locale: "ar_SA",
  },
};
        ...
        <section className="mx-auto max-w-3xl px-4 py-8">
          <div className="rounded-2xl border border-brand-border bg-white p-6 sm:p-8 shadow-card space-y-6">
            ...
            <div className="space-y-3 text-sm leading-relaxed text-ink-secondary">
              ...
              <p>
                نظام العمل السعودي الصادر بالمرسوم الملكي (م/51) يُحدد بدقة حقوق العامل عند انتهاء الخدمة. وقد شهدت المواد الجوهرية المنظِّمة لهذه العلاقة — كالمادتين (84) و(85) الخاصتين بمكافأة نهاية الخدمة، والمادة (111) الخاصة ببدل الإجازة السنوية، والمادتين (75) و(76) الخاصتين بمهلة الإشعار — تعديلات جوهرية أُعلن عنها في فبراير 2025 ودخلت حيز التنفيذ الرسمي. تعكس هذه الحاسبة التعديلات الأخيرة وفق النص الرسمي المنشور على موقع وزارة الموارد البشرية والتنمية الاجتماعية.
              </p>
            </div>
            ...
            <div>
              ...
              <ol className="space-y-2 text-sm text-ink-secondary list-none">
                {[
                  ["١", "أدخل بيانات الموظف وجهة العمل للوثيقة الرسمية (اختياري للحساب)."],
                  ...
                  ["٦", "أدخل مهلة الإشعار المطلوبة والمخدومة لحساب التعويض إن وُجد."],
                  ["٧", "أضف أي مستحقات أخرى (رواتب متأخرة، أوفر تايم) أو خصومات (سلف، عهد)."],
                  ["٨", "اقرأ تفصيل المخالصة في لوحة النتائج، ثم أصدر الوثيقة الرسمية للطباعة."],
                ].map(([n, text]) => (
