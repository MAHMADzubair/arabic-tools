...
export const TOOLS = [
  ...
  },
  {
    ...
    nameAr: "حاسبة المخالصة النهائية",
    nameEn: "Final Settlement Calculator",
    descAr: "تصفية شاملة لجميع مستحقات العامل في السعودية: مكافأة نهاية الخدمة، آخر راتب، رصيد الإجازات، ومهلة الإشعار مع وثيقة رسمية للطباعة.",
    icon: "📋",
    category: "gulf",
