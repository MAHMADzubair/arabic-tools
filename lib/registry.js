...
export const COUNTRIES = {
  sa: {
    ...
    metaDesc: "أدوات وحاسبات مخصصة للمملكة العربية السعودية — راتب، مكافأة، ضريبة القيمة المضافة وأكثر.",
  },
  ae: {
    code: "ae",
    ...
    bg: "bg-red-50",
    border: "border-red-200",
    metaDesc: "أدوات وحاسبات مخصصة للإمارات العربية المتحدة — راتب، مكافأة، ضريبة القيمة المضافة وأكثر.",
  },
  qa: {
    code: "qa",
    nameAr: "قطر",
