...
export const TOOLS = [
  ...
  },
  {
    ...
    descAr: "احسب أجر ساعات العمل الإضافي وفق قوانين العمل الخليجية لكل دولة — 150% بالسعودية، 125% و150% بالإمارات.",
    icon: "⏱️",
    category: "gulf",
  ...
  {
    id: "final-settlement-calculator",
    nameAr: "حاسبة المخالصة النهائية في السعودية",
    nameEn: "Saudi Final Settlement Calculator",
    descAr: "تصفية شاملة لجميع مستحقات العامل في السعودية: مكافأة نهاية الخدمة، آخر راتب، رصيد الإجازات، وبدل الإشعار مع نموذج مخالصة قابل للطباعة.",
    descriptionAr: "تصفية شاملة لجميع مستحقات العامل في السعودية: مكافأة نهاية الخدمة، آخر راتب، رصيد الإجازات، وبدل الإشعار مع نموذج مخالصة قابل للطباعة.",
    icon: "📋",
    category: "gulf",
  ...
  {
    id: "saudi-annual-leave-calculator",
    nameAr: "حاسبة رصيد الإجازات في السعودية",
    nameEn: "Saudi Annual Leave Calculator",
    descAr: "احسب رصيد إجازتك السنوية وأجر أيام الإجازة والتعويض النقدي لرصيد الإجازات غير المستنفدة وفق المادتين 109 و111 بنظام العمل السعودي.",
    descriptionAr: "احسب رصيد إجازتك السنوية وأجر أيام الإجازة والتعويض النقدي لرصيد الإجازات غير المستنفدة وفق المادتين 109 و111 بنظام العمل السعودي.",
    icon: "🏖️",
    category: "gulf",
  ...
  },
  {
    ...
    descAr: "احسب رصيد إجازاتك وأجر أيام الإجازة والتعويض النقدي عن الرصيد المتبقي للسعودية والإمارات والكويت ومصر.",
    descriptionAr: "احسب رصيد إجازتك السنوية وأجر أيام الإجازة والتعويض النقدي عن الرصيد المتبقي للسعودية والإمارات والكويت ومصر.",
    icon: "🏖️",
    category: "gulf",
    href: "/annual-leave-calculator",
    status: "active",
    countries: ["sa", "ae", "kw", "eg"],
    featured: true,
    badge: null,
  },
  {
    id: "article-77-calculator",
    nameAr: "حاسبة تعويض المادة 77",
    nameEn: "Article 77 Compensation Calculator",
    descAr: "احسب تعويض إنهاء عقد العمل لسبب غير مشروع (الفصل التعسفي) بموجب المادة 77 بنظام العمل السعودي مع الحد الأدنى (شهرين).",
    descriptionAr: "احسب تعويض إنهاء عقد العمل لسبب غير مشروع (الفصل التعسفي) بموجب المادة 77 بنظام العمل السعودي مع الحد الأدنى (شهرين).",
    icon: "⚖️",
    category: "gulf",
...
// Normalize tool fields to guarantee id, nameAr, descriptionAr, href, category, country, status, icon, featured
TOOLS.forEach((t) => {
  if (!t.descriptionAr) t.descriptionAr = t.descAr;
  if (!t.descAr) t.descAr = t.descriptionAr;
  if (!t.country) t.country = t.countries && t.countries.length === 1 ? t.countries[0] : null;
});
...
export const COUNTRIES = {
  sa: {
    ...
    metaDesc: "أدوات وحاسبات مالية وعمالية مخصصة للمملكة العربية السعودية 2026 — حاسبة الراتب وGOSI وساند، مكافأة نهاية الخدمة (م 84/85)، الأوفر تايم 150%، وضريبة 15%.",
  },
  ae: {
    code: "ae",
    ...
    bg: "bg-red-50",
    border: "border-red-200",
    metaDesc: "أدوات وحاسبات مالية وعمالية مخصصة للإمارات 2026 — حاسبة الراتب وWPS، مكافأة نهاية الخدمة (قانون 33 م 51)، الأوفر تايم 125% و150%، وضريبة 5%.",
  },
  qa: {
    code: "qa",
    nameAr: "قطر",
    ...
    bg: "bg-purple-50",
    border: "border-purple-200",
    metaDesc: "أدوات وحاسبات مخصصة لقطر — راتب، مكافأة نهاية الخدمة، وأكثر.",
  },
  kw: {
    code: "kw",
    nameAr: "الكويت",
    ...
    bg: "bg-green-50",
    border: "border-green-200",
    metaDesc: "أدوات وحاسبات مخصصة للكويت — راتب، مكافأة نهاية الخدمة، وأكثر.",
  },
  om: {
    code: "om",
    nameAr: "سلطنة عُمان",
    ...
    bg: "bg-red-50",
    border: "border-red-200",
    metaDesc: "أدوات وحاسبات مخصصة لسلطنة عُمان — راتب، مكافأة نهاية الخدمة، وأكثر.",
  },
  bh: {
    code: "bh",
    nameAr: "البحرين",
    ...
    bg: "bg-red-50",
    border: "border-red-200",
    metaDesc: "أدوات وحاسبات مخصصة للبحرين — راتب، مكافأة نهاية الخدمة، وأكثر.",
  },
};
